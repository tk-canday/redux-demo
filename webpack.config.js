...
// 如果样式表总量很大，那么它会更快，因为CSS包与JS包并行加载。
...
module.exports = {
    ...
    entry: {
        ...
        // 这里是依赖库的文件配置，和CommonsChunkPlugin配合使用可以单独打包
        common: ['react','react-dom','react-router','redux','react-redux','mockjs']
    },
    output: {
